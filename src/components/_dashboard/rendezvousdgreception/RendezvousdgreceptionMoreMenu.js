...
export default function RendezvousdgreceptionMoreMenu({ idRendezvous, sendInformation }) {
  ...
  const deleteAgence = () => {
    axios
      .delete(`${process.env.REACT_APP_BASE_URL}/rendezvousdgreception/${idRendezvous}`, {
        headers: {
