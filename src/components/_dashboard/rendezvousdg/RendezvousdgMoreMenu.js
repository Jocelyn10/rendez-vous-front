...
// import userConfig from 'front/src/utils/config';
...
export default function RendezvousdgMoreMenu({
  idRendezvous,
  nameDg,
  fonctionDg,
  motifDg,
  ...
  const deleteAgence = () => {
    axios
      .delete(`${process.env.REACT_APP_BASE_URL}/rendezvousdg/${idRendezvous}`, {
        headers: {
  ...
  const modifyRendezvousdg = () => {
    axios
      .put(
        `${process.env.REACT_APP_BASE_URL}/rendezvousdg/${idRendezvous}`,
        {
          name,
          fonction,
          motif,
      ...
      {openModal ? (
        ...
        >
          <div className={classes.paper}>
            ...
            />
            <Button onClick={() => modifyRendezvousdg()} variant="contained">
              Sauvegarder
            </Button>
          </div>
        </Modal>
