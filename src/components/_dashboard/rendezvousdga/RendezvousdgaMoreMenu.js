...
export default function RendezvousdgaMoreMenu({
  idRendezvous,
  nameDg,
  fonctionDg,
  motifDg,
  ...
  const deleteRendezvous = () => {
    axios
      .delete(`${process.env.REACT_APP_BASE_URL}/rendezvousdga/${idRendezvous}`, {
        headers: {
      ...
      {openModal ? (
        ...
        >
          <div className={classes.paper}>
            ...
            />
            <Button onClick={() => modifyRendezvousdga()} variant="contained">
              Sauvegarder
            </Button>
          </div>
        </Modal>
